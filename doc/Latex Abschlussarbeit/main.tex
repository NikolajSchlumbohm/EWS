...
\author{David Lika, Jan Felix Deuse, Joris Engels, Maik Philipp Paulsen \\
 ...
 Felix Zurhausen, Sebastian Wixforth, Tim Niklas Nötzold}
%\author{Maja Mustermann, Max Musterfrau} \author{First Middle Last Name\\Second Student with somewhat longer Name}
\email{david.lika@uni-muenster.de, jan.deuse@uni-muenster.de, joris.engels@uni-muenster.de, mpaulsen@uni-muenster.de, nschlumb@uni-muenster.de, philip.van.rickelen@uni-muenster.de, jan.schnorrenberg@uni-muenster.de, fabian.kizio@uni-muenster.de, fzurhaus@uni-muenster.de, swixforth@uni-muenster.de, tnoetzol@uni-muenster.de}
% Matriculation Number
\id{537160, 537390, 536427, 537809, 537506, 539435, 536480, 526085, 536827, 536908, 528136}
...
\begin{abstract}
In diesem Projektseminar wurde systematisch untersucht, wie visuelle Aufmerksamkeit durch Eye-Tracking erfasst, analysiert und interpretiert werden kann. Grundlage für dieses Vorhaben war ein zweistufiges Vorgehen, wobei im ersten Schritt eine explorative Analyse durchgeführt wurde, um Strukturen und Muster sichtbar zu machen. Basierend darauf folgte eine hypothesengeleitete Untersuchung spezifischer Fragestellungen. Besonders auffällige Ergebnisse, die sich aus den gesammelten Eye-Tracking Daten ableiten lassen, sind beispielweise die aufmerksamkeitsbinde Eigenschaft von Textelementen oder das Beobachten von Ermüdungseffekten im Laufe der Betrachtungszeit. Es lässt sich beobachten, dass Kontrastmetriken signifikant mit Fixationsmustern korrelieren. Rekurrenzanalysen weisen darauf hin, dass Gesichter und Texte charakteristische Wiederholungsmuster hervorrufen, wohingegen Landschaften zerstreutes und exploratives Blickverhalten erzeugen. Insgesamt verdeutlicht die Studie, dass Blickverhalten nicht zufällig ist, sondern durch konkrete Bildmerkmale und den zeitlichen Kontext systematisch bestimmt wird. Die Ergebnisse liefern methodische und inhaltliche Impulse für die weitere Forschung und die Anwenung multimodaler Ansätze.  
\end{abstract}
...
\section{Clustern}
Die Clusteranalyse fasst die Fixations-Zusammenfassungen pro Bild zu Verhaltensarchetypen zusammen.
Eine Kreuztabelle aus Clustern und Labels ordnet alle 152 annotierten Stimuli über drei Cluster hinweg und zeigt, 
wie Bilder den Lösungsraum füllen, der die weitere Interpretation steuert.
...
den die Probanden in der Regel sorgfältig lasen. Abbildung \ref{fig:katMatrix} zeigt die Betrachtungsdauer der einzelnen 
...
\begin{figure}[h]
	...
	\caption{Aggregierte Heatmap des Bildes mit ID 144}\label{fig:bildid144}
\end{figure}
